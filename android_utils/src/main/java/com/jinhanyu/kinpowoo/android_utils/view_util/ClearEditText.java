...
public class ClearEditText extends EditText implements
    ...
    private void init() {
        ...
        if (mClearDrawable == null) { 
       	mClearDrawable = getResources().getDrawable(MyResource.getIdByName(getContext(),"ClearEditText","delete"));
        }
        mSearchDrawable = getCompoundDrawables()[0];
        mSearchDrawable = getResources().getDrawable(MyResource.getIdByName(getContext(),"ClearEditText","search"));
